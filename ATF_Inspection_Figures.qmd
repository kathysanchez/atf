...
Figure 2 shows that Dallas, Kansas City and Columbus—cities in the south and midwest—had the most inspections over the full period of data. Field Offices in the west and northeast tended to have fewer inspections. These differences are likely because ATF field offices receive more funding when they have more licensees in their area.
...
Field offices that issued the most warnings and revoked the most licenses (Figures 3 and 4) were similar to those that had the most inspections (Figure 2). These similarities suggest that so-called rogue gun dealers are not concentrated in or attracted to any particular area.
